...
public class HipsterPanel extends JPanel
{
	...
	private void setupLayout()
	{
		...
		baseLayout.putConstraint(SpringLayout.NORTH, bookAuthorLabel, 76, SpringLayout.NORTH, this);
		baseLayout.putConstraint(SpringLayout.EAST, bookAuthorLabel, -112, SpringLayout.EAST, this);
		...
		baseLayout.putConstraint(SpringLayout.NORTH, changeBookButton, 10, SpringLayout.SOUTH, bookPriceLabel);
		baseLayout.putConstraint(SpringLayout.EAST, changeBookButton, -84, SpringLayout.EAST, this);
	...
	private void setupListeners()
	{
		...
		{
			public void actionPerformed(ActionEvent selecion)
			{
		...
		changeBookButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent click)
			{
				...
				if(startClick < maxClicks)
				{
					...
					bookPriceLabel.setText("Book prices: " + tempBooks[startClick].getPrice());
					startClick++;
				}
				else
				{
